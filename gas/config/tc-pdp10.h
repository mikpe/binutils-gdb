...
/* This must not be used for code or runtime data.  */
#define md_number_to_chars number_to_chars_bigendian

/* This converts nonets to pairs of octets.  Use for all code and runtime data.  */
extern void pdp10_number_to_chars_progbits (char *, valueT, int);
#define md_number_to_chars_progbits pdp10_number_to_chars_progbits
